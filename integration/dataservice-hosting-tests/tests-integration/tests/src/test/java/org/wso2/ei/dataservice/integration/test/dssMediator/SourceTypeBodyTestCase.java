...
public class SourceTypeBodyTestCase extends ESBIntegrationTest {
    ...
    public void serviceDeployment() throws Exception {
        super.init();
        verifyProxyServiceExistence("sourceTypeBodyProxy");
    }
    ...
    private String sendPostRequest(String payload) {
        ...
        try {
            ...
            HttpResponse response = simpleHttpClient.doPost(getProxyServiceURLHttp("sourceTypeBodyProxy"), null, payload, "application/xml");
